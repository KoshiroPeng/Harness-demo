...
如果下一步要把这些规范接成自动检查或 CI 提醒，优先联读 [docs/conventions/harness-automation-roadmap.md](harness-automation-roadmap.md)、[docs/conventions/automation-check-catalog.md](automation-check-catalog.md)、[docs/conventions/automation-message-guidelines.md](automation-message-guidelines.md)、[docs/plans/harness-automation-implementation-brief.md](../plans/harness-automation-implementation-brief.md) 和 [docs/plans/phase1-doc-check-ci-brief.md](../plans/phase1-doc-check-ci-brief.md)。
