...
| 自动化接入总导航页 | [docs/plans/automation-delivery-map.md](../plans/automation-delivery-map.md) |
| 自动化阶段验收清单 | [docs/plans/automation-phase-acceptance-checklist.md](../plans/automation-phase-acceptance-checklist.md) |
...
如果当前任务还没判断清楚先看哪些文档、改动时要同步哪些材料，先看 [docs/conventions/development-execution-guide.md](development-execution-guide.md)。

如果当前任务已经明确要改哪些代码、接口、SQL 或发布材料，但不确定还要同步哪些文档，优先看 [docs/conventions/change-trigger-matrix.md](change-trigger-matrix.md)。

如果下一步要把这些规范接成自动检查或 CI 提醒，优先联读 [docs/conventions/harness-automation-roadmap.md](harness-automation-roadmap.md)、[docs/conventions/automation-check-catalog.md](automation-check-catalog.md)、[docs/conventions/automation-message-guidelines.md](automation-message-guidelines.md)、[docs/plans/automation-delivery-map.md](../plans/automation-delivery-map.md)、[docs/plans/automation-phase-acceptance-checklist.md](../plans/automation-phase-acceptance-checklist.md)、[docs/plans/harness-automation-implementation-brief.md](../plans/harness-automation-implementation-brief.md)、[docs/plans/phase1-doc-check-ci-brief.md](../plans/phase1-doc-check-ci-brief.md)、[docs/plans/phase2-history-scan-brief.md](../plans/phase2-history-scan-brief.md)、[docs/plans/phase3-workflow-path-check-brief.md](../plans/phase3-workflow-path-check-brief.md) 和 [docs/plans/phase4-doc-sync-reminder-brief.md](../plans/phase4-doc-sync-reminder-brief.md)。
